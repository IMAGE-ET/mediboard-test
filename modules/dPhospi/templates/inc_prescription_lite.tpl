          ...
          <table class="form"> 
            <tr>
              <td style="text-align: center;">
                <form name="addLineCommentMedSuiviSoins" method="post" action="" onsubmit="return onSubmitFormAjax(this, { onComplete: function(){ Control.Modal.close(); Prescription.reload('{{$prescription->_id}}',null,'medicament')} } )">
                  <input type="hidden" name="m" value="dPprescription" />
