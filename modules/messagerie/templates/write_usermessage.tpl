...
<div id="tab_mail">
  <form name="EditUserMessage" action="?m={{$m}}" method="post" onsubmit="return checkForm(this)">
    ...
    <table class="form">
      ...
      <tr>
        <td colspan="2" style="text-align: center;">
          <button type="button" onclick="window.parent.Control.Modal.close(); window.parent.UserMessage.create({{$usermessage->_ref_user_from->_id}}, null, 'Re: {{$usermessage->_clean_subject}}'); ">
