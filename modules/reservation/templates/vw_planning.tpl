  ...
  <table class="form">
    <tr>
      <th class="category" colspan="5">
        <span style="float:left;"><button id="autorefreshPlanningButton" class="play"
        ...
        {{if $plageop->_can->edit}}
          <span style="float:left;"><button id="autorefreshPlanningButton" class="new" onclick="modifPlage();" type="button">Ajouter
              une plage
            </button></span>
        {{/if}}
        Filtre
