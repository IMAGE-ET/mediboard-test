  ...
  <table class="form">
    ...
    <tr>
      ...
      <td colspan="3">
        ...
        {{if $ex_picture->_id}}
          <button type="button" class="trash" onclick="confirmDeletion(this.form,{ajax:true,typeName:'le sous groupe ',objName:'{{$ex_picture->_view|smarty:nodefaults|JSAttribute}}'},ExClass.edit.curry('{{$ex_group->ex_class_id}}'))">
            {{tr}}Delete{{/tr}}
          </button>
